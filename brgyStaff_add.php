...
if (isset($_POST['Submit'])) {
  ...
  header('location: brgyStaff_add.php');
}
?>
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Add Barangay Staff</h1>
                  </div>
                  <form method="post" action="brgyStaff_add.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="submit" name="Submit" class="btn btn-success btn-sm btn-flat" value="Add Staff">
                      <a href="brgyStaff.php" class="btn btn-danger btn-sm  btn-flat"> Close </a>
                    </div>
                    <hr>
