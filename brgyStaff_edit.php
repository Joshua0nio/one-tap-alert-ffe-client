            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form action="brgyStaff_edit.php" method="POST">
