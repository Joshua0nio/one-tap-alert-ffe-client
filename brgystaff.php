...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Barangay Staffs</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="./">Home</a></li>
      <li class="breadcrumb-item">Users</li>
      <li class="breadcrumb-item active" aria-current="page">Barangay Staffs</li>
    </ol>
  </div>
          ...
          WHERE u.user_type_id = 4;";
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href=" brgyStaff_edit.php?id=<?php echo $row['id'] ?>" class="btn btn-success btn-sm edit btn-flat"><i class="fa fa-edit"></i>Edit</a>
                    <a href=" brgyStaff_delete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm  btn-flat"><i class="fa fa-trash"></i> Delete</a>
                  </td>
                </tr>
              <?php
              }
