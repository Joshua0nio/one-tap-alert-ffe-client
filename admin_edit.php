                  ...
                  <form action="admin_edit.php" method="POST">
                    ...
                    <div class="form-group">
                      <select class="form-control" name="barangay" aria-label="Default select example">
                        <option value="<?php echo $usertypesID; ?>"><?php echo $brgy; ?></option>
                        <?php
