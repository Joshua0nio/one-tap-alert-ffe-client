...
if (isset($_POST['Submit'])) {
  ...
  header('location: ccStaff_add.php');
}
?>
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Add Command & Control Staff</h1>
                  </div>
                  <form method="post" action="ccStaff_add.php" enctype="multipart/form-data">
